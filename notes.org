...
** RANDOM IDEAS
   ...
   + [ ] Representation (cameos?) from Growing Up?
     - [ ] "Ricky Riddle" in particular is just asking to be made into
       a supervillain ;)
   ...
   + [X] Should Destiny's Song be a Hero card? I like that idea
     ...
     a Destiny deck)
   + [ ] Reskin Second Course to be, maybe, "Second Plate". I keep
   ...
   + [ ] Rule 18 (Shape support) - Rule 18 looks like the triforce, so
     ...
     - [ ] Rule 18 :: Effect card, lasts 3 turns, limit 1 per deck, no
       additional effects.
     - [ ] Rule of Strength :: If you control Rule 18, then +2 Level
       to your strongest SHAPE Minion.
     - [ ] Rule of Knowledge :: If you control Rule 18, then +2 Morale
       to your strongest SHAPE Minion.
     - [ ] Rule of Bravery :: If you control Rule 18, then all of your
   ...
   + [ ] A way to store EP for a future turn (maybe a factory card?)
   + [ ] Diceman and dice pseudo-archetype (for random effects, lots
     of synergy options)
   + [ ] Something that costs 9 EP. I checked; we can fit nine stars
     on the card.
** SCRAPPED IDEAS
