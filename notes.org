...
**** STAMP VILLAINS
     ...
     + Count Carbonara :: Pasta-obsessed supervillain and holder of
       ...
       intrusion.
       - Later (after Ravengirl defeats him but before the postgame),
         Count Carbonara opens a portal to the Pasta Dimension in
         search of the fabled Destiny's Singer card and gets sucked
         in. In the Pasta Dimension, he faces Ravengirl with Destiny's
         Singer in his deck.
...
**** STAMP VILLAIN SIDEKICKS
     + Barry the Brainless Overlord :: Robot-obsessed supervillain
       ...
       - Right before the start of the game, he accidentally exploded
         ...
         Additionally, they repair the Minionmansion (for an optional
         post-game endurance test) after you beat the game.
...
**** THE FINAL GAUNTLET
     ...
     + Minionman :: Again but with his mask off and going by his real
       ...
       - Minionman's real name is **Reginald Randolph**. He runs a
         massive underground weapons smuggling operation and uses the
         "Minionman" persona to throw the cops and superheroes off and
         make them not take him seriously.
     + The King of Crime :: Ravenboy is really the King of Crime. Once
       Ravengirl defeats Reginald (Minionman's unmasked
       form), she earns the right to meet and face the King of Crime
       himself.
**** RECURRING RIVALS
     ...
     + Chris Cogsworth :: Not a supervillain, just cleans clocks and
       was disappointed to learn that the convention is about evil and
       not (as per the convention's cover story) about clock
       polishing.
...
**** OPTIONAL BONUS BOSSES
     ...
     + +Maybe the boss from Mars God of War?+
       - Cameos in the form of the /Performance Review/ card. Will not
         appear in person in-game.
     + +Someone from Three Rules?+
       - The three Rulers appear as effect cards. The characters will
         not appear in person.
     + +Inquisitor from Suspicious City?+
       - Appears as a card. The character will not appear in person.
...
*** MISCELLANEOUS
    + When a card (usually a Clown-themed card) changes the archetype
      ...
      - Wild Card (which makes a Minion act as all archetypes at once)
        always takes precedent over /any/ archetype changes. A Minion
        with the Wild Card status cannot have its archetype overridden
...
** RANDOM IDEAS
   ...
   + [ ] For story reasons, Mystery Box should blacklist a handful of
     cards (Reginald and King of Crime, mainly) unless Ravengirl has
     seen those characters already.
