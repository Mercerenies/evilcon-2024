...
func _evaluate_effect(playing_field, card) -> void:
    ...
    playing_field.event_logger.LogEvent(playing_field.turn_number, owner, LogEvents.SQUAREDUDE_PLAYED)

    var targets
    if playing_field.event_logger.HasEvent(playing_field.turn_number, owner, LogEvents.CIRCLEGIRL_PLAYED):
...
func ai_get_score(playing_field, player: StringName, priorities) -> float:
    ...
    if playing_field.event_logger.HasEvent(playing_field.turn_number, player, LogEvents.CIRCLEGIRL_PLAYED):
