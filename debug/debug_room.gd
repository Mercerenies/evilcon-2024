...
func _debug_interactive_game():
    ...
    $PlayingField.get_hand(CardPlayer.TOP).cards().push_card(PlayingCardCodex.get_entity(PlayingCardCodex.ID.LIFE_FORCE_CANNON))
...
func _sample_deck():
    return [
        ...
        PlayingCardCodex.get_entity(PlayingCardCodex.ID.ANCIENT_DEMON),
